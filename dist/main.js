...
Video.prototype.willUpdate = function willUpdate () {
  return (this.embed ? true : false);
};

Video.prototype.updateSource = function updateSource (newSource) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _components_video__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/video */ "./scripts/components/video.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "jquery");


var Home = function Home() {
  Object.assign(this, Object.assign(Object.seal({
    video: new _components_video__WEBPACK_IMPORTED_MODULE_0__.default(),
  })));
};

Home.prototype.showVideoListener = function showVideoListener () {
    var this$1 = this;

  if (this.video.willUpdate()) {
    $(this.video.modal).on('shown.bs.modal', function () {
      this$1.video.updateSource(((this$1.video.source) + "?" + (this$1.video.queryString)));
    });
  }
};

Home.prototype.hideVideoListener = function hideVideoListener () {
    var this$1 = this;

  if (this.video.willUpdate()) {
    $(this.video.modal).on('hide.bs.modal', function () {
      this$1.video.updateSource(this$1.video.source);
    });
  }
};
...
/* harmony import */ var _scripts_pages_home__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/pages/home */ "./scripts/pages/home.js");
...
var pages = [_scripts_pages_home__WEBPACK_IMPORTED_MODULE_2__.default];
